...
<head>
  ...
  <script src="https://kit.fontawesome.com/1faaff04b9.js" crossorigin="anonymous"></script>
  <!-- Bootstrap CSS -->
  ...
  <link href="https://fonts.googleapis.com/css2?family=Lilita+One&family=Montserrat:wght@100;300;400;500;900&family=Ubuntu:wght@300;400;700&display=swap" rel="stylesheet">
  ...
  <title>Sanketh's Basic Banking System</title>
  <style>
    * {
...
<body>
  <nav>
    <div class="container-fluid nav-wrapper #96CEB4  darken-3 z-depth-5 active sticky">
  ...
  <div class="center head mt-0">
    <h2 style="color:#FD5F00"><b><span><img src="https://www.thesparksfoundationsingapore.org/images/logo_small.png" style="height:70px;width:60px;" /></span>SANKETH BANK</b></h2>
  </div>
  ...
  <footer class="center footer">
    <h6 class="info"><b>2022 © Made by Sanketh K Kumar</b></h6>
  ...
  <div class="bottom-container" align="center">
    <a href="https://www.instagram.com/sanketh_kumar_123/?utm_medium=copy_link" target="_blank"><i class="fab fa-instagram fa-4x"></i></a>
    <a href="https://www.linkedin.com/in/kistappagari-sanketh-kumar-3b5676216/" target="_blank"><i class="fab fa-linkedin fa-4x"></i></a>
    <a href="https://github.com/Sanketh149" target="_blank"><i class="fab fa-github fa-4x"></i></a>
  </div>
